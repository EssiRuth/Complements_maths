...
> Ces observations montrent que, bien que certains attributs soient informatifs, le modèle naïf bayésien pourrait avoir une **capacité de séparation limitée**, notamment si les hypothèses d’indépendance ou de distributions normales sont trop éloignées de la réalité des données.

#### 4.2 Visualisation des densités conditionnelles
...
#### 4.3 Prédiction finale et évaluation des performances
