...
```
Nous utilisons l’arbre élagué pour effectuer des prédictions sur le jeu de test pour calculer les 
```{r}
...
```
## 3. Arbre de classification avec évaluation des performances en 10-fold cross-validation
