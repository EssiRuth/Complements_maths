...
install.packages("naivebayes") # Installer le package
library(naivebayes) # Charger le package

# 2.3 Apprentissage du classifieur Naïve Bayésien
# Assurez-vous d'utiliser la partie Train uniquement
# 'train_data' doit être un data frame avec les variables explicatives
# 'target_train' doit être la variable cible (Heart.Attack.Risk)

# Vérification des dimensions des données
dim(train_data)
head(target_train)

# Entraînement du modèle avec les variables explicatives et la cible
...
# Nous allons maintenant prédire directement la classe (0 ou 1) pour chaque observation du jeu de test
...
# Recall (rappel des survivants) : calcul du rappel pour la classe "survivant" (1)
recall_value = recall(target_pred, target_test, positive = "1")

# Precision (précision des survivants) : calcul de la précision pour la classe "survivant" (1)
precision_value = precision(target_pred, target_test, positive = "1")

# Affichage des résultats de performance
print(paste("Accuracy: ", accuracy))
print(paste("Recall (survivant): ", recall_value))
print(paste("Precision (survivant): ", precision_value))
```
